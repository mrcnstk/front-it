...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Właściwość Z-INDEX - pytanie</h2>
                <hr>
                <h3> Który element będzie z przodu strony?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">z-index: 90;<br/>
                    <input type="radio" name="question" value="2">z-index: 2;<br/>
                  <input type="radio" name="question" value="3">z-index: 13;<br/>
                    <input type="radio" name="question" value="4">z-index: 88;<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../../css3/wprowadzenie/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
