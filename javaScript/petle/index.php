...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            ...
            <h2>Pętle</h2>
                <hr>
                <p>Nie raz spotkamy się z sytuacją, kiedy chcemy wielokrotnie powtórzyc daną czynność. W programowaniu nie ma mowy o klepaniu tak dużej ilości kodu, ponieważ tutaj na pomoc przychodzą pętle. Pętla to pewnego rodzaju funkcja, która jest w stanie wykonywać dany blok kodu określoną ilość razy
                W języku JavaScript mamy trzy typy pętli: for, while oraz do while. Dzisaj poznamy jedną z podstawowych pętli, czyli pętle <b>for</b>. Pętla ta wygląda następująco:
                </p> 
               <br/>
               <div class="code_box"><br/><p>
                ...
                <br/>
                <p>Pętla FOR przyjmuje trzy argumenty: pierwszy określa wartość początkową, od której startuje pętla. Drugi argument to warunek, który jest sprawdzany przy kazdym wykonaniu pętli, a trzeci to inkrementacja. Opis tej pętli brzmi następująco:</p>
                <p><b> Przypisz do zmiennej "i" liczbę 0. Wykonuj kod poniżej dopóki zmienna "i" jest mniejsza lub równa 5. Przy każdym przejściu zwiększaj "i" o jeden. </b> </p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../jezeli/index.php"><button class="btn-primary">Wstecz</button></a>
