    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Pętle - pytanie</h2>
                <hr>
                <h3>Do czego służą pętle? </h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Do obciążania programu<br/>
                    <input type="radio" name="question" value="2">Do testowania programu<br/>
                 <input type="radio" name="question" value="3">Do wykonywania danego bloku programu kilkukrotnie<br/>
                ...
                <a href="../../spis_tresci/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
