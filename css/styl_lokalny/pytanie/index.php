...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Styl lokalny - pytanie</h2>
                <hr>
                <h3> Wprowadzając style w znaczniku otwierającym P zadziałają one na:</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Element poprzedzający znacznik P<br/>
                    <input type="radio" name="question" value="2">Zawartość pomiędzy znacznikami P<br/>
                    <input type="radio" name="question" value="3">Wszystko po zamykającym znaczniku P<br/>
                ...
                <a href="../../styl_w_naglowku/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
