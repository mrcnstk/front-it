...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Wypisywanie na ekran - pytanie</h2>
                <hr>
                <h3> Jaka funkcja odpowiada za wypisanie ciągu znaków na ekran?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">document.write()<br/>
                    <input type="radio" name="question" value="2">document.read()<br/>
                 <input type="radio" name="question" value="3">document.show()<br/>
                   <input type="radio" name="question" value="4">document.string()<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../komentarze/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
