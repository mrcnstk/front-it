    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                ...
                <hr>
                <p>Operatory arytmetyczne służą do wykonywania działań na liczbach lub zmiennych. W tym miejscu najlepiej będzie posłuzyć się tabelą (tutaj zmienna <b>y jest równa 5</b>):</p> 
               <br/>
               <img src="../../images/operatory.png" alt="Operatory" style="margin-left:100px;"/>
               <br/>
               <p style="font-size:10px;">Źródło: https://kursjs.pl/kurs/super-podstawy/operatory.php</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../zmienne_cz2/index.php"><button class="btn-primary">Wstecz</button></a>
