...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Formularze - pytanie</h2>
                <hr>
                <h3>Jaką metodę przesyłania danych uznaje się za bezpieczniejszą?</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1">GET<br/>
                    <input type="radio" name="question" value="2"> SEND <br/>
                    <input type="radio" name="question" value="3"> POST <br/>
                    <input type="radio" name="question" value="4"> ACTION <br/>
                </form>
                <br/><br/><br/>    
