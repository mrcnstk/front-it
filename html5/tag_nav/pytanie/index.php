...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag NAV - pytanie</h2>
                <hr>
                <h3> Do czego stosuje się znacznik NAV?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Do tworzenia artykułów<br/>
                    <input type="radio" name="question" value="2">Do tworzenia nawigacji<br/>
                    <input type="radio" name="question" value="3">Nie ma określonego zastosowania<br/>
                    <input type="radio" name="question" value="4">Tylko do wprowadzania poufnych danych<br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../tag_article/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
