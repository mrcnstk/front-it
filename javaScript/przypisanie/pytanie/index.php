...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Operatory przypisania - pytanie</h2>
                <hr>
                <h3>Który operator tylko przypisuje wartość do zmiennej? </h3>  
                <br/>
                <form>
                ...
                <a href="../../porownanie/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
