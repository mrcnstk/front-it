...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Czym jest HTML? - pytanie</h2>
                <hr>
                <h3> Czego używa język HTML do identyfikowania zawartości?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Funkcji<br/>
                    <input type="radio" name="question" value="2">Skryptów<br/>
                    <input type="radio" name="question" value="3">Komend<br/>
                    <input type="radio" name="question" value="4">Znaczników<br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../struktura_dokumentu/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
