...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>CSS3 - wprowadzenie</h2>
                <hr>
                <p>CSS3 jest najnowszym standardem arkuszy stylów, który wprowadza wiele ciekawych możliwości. Warto zaznaczyć, że jest on w pełni kompatybilny z poprzednimi wersjami CSS.</p> 
               <br/>
               <p>Właściwości, które omówimy w tym kursie:</p>
               <br/>
               <p><b>border-radius</b> - pozwala na zaokrąglanie narożników danego elementu</p>
               <br/>
               <p><b>border-images</b> - pozwala na ustawienie zdjęcia/obrazu jako ramki wokół elementu</p>
               <br/>
               <p><b>box-shadow</b> - pozwala na dodanie cieni do danych elementów</p>
               <br/>
               <p><b>linear-gradient i radial-gradient</b> - pozwala na utworzenie gradientu liniowego oraz kołowego</p>
               <br/>
               <p><b>animation</b> - pozwala na animowanie obiektów</p>
