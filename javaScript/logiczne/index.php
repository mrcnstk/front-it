    ...
    <div id="main">
        ...
        <div class="mainbox">
            ...
            <h2>Operatory logiczne</h2>
                <hr>
                <p>Operatory logiczne często służą do łączenia kilku warunków. Dzięki nim nie musimy pisać kilku linii kodu osobno, a połączyć wszystko w jedną całość (<b>x = 6 i y = 3</b>): </p> 
               <br/>
               <img src="../../images/logiczne.png" alt="Operatory logiczne" style="margin-left:100px;"/>
               <br/>
               <p style="font-size:10px;">Źródło: https://kursjs.pl/kurs/super-podstawy/operatory.php</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../porownanie/index.php"><button class="btn-primary">Wstecz</button></a>
