...
<body>
    <div id="main">
        ...
        <nav class="nav_bar">
            ...
            <a class="blue" href="index.php">Style</a>
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Style - wprowadzenie</h2>
                <hr>
                <p>Mając za sobą podstawy HTML oraz wprowadzenie do HTML5, najwyższy czas przejść o krok dalej. Dzisiaj dowiesz się czym są style i dlaczego to takie proste.</p>
                <p> Kaskadowe Arkusze Stylów (czyli CSS- ang. Cascading Style Sheets) to tak na prawdę ani język programowania, ani język znaczników. To po prostu "arkusz", czyli plik, który definiuje nam jak co ma wyglądać. 
                Chcemy aby nasz tekst był koloru zielonego? Nie ma problemu. A może chcemy aby tło naszej strony przechodziło z niebieskiego koloru w czerwony? Jak najbardziej możliwe. To tylko nieznaczny procent możliwości, jakie oferuje nam CSS.
                Kliknij przycisk poniżej, aby przejść do kursu CSS i poznać podstawy stylowania elementów.</p>
               <br/> <br/> <br/>
               <div class="bottom_buttons">
               <a href="../css/spis_tresci/index.php"><button class="btn-primary">Przejdź do kursu</button></a>
               </div>
            </div>
        </div>
    </div>
