...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Atrybuty - pytanie</h2>
                <hr>
                <h3>Czy poniższe zastosowanie atrybutu jest poprawne?</h3>  
                <br/>
                <div class="code_box"><br/><p>&lt;html&gt;<br/>
                &lt;head&gt;<br/>
                &lt;title&gt; Atrybuty &lt;/title&gt;<br/>
                &lt;/head&gt;<br/><br/>
                &lt;body&gt;<br/>
                &lt;p width="100px" height="50px"&gt; Tekst &lt;/p&gt;<br/>
                &lt;/body&gt;<br/>
                &lt;/html&gt;<p></div><br/>
                <form>
                <input type="radio" name="question" value="1"> Nie <br/>
                    <input type="radio" name="question" value="2"> Tak <br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../obrazy/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
