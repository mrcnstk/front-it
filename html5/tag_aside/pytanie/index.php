...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag ASIDE - pytanie</h2>
                <hr>
                <h3> Z ilu znaczników składa się podstawowa struktura HTML5?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">3<br/>
                    <input type="radio" name="question" value="2">6<br/>
                    <input type="radio" name="question" value="3">5<br/>
                ...
                <a href="../../../style_wprowadzenie/index.php"><button name="go" class="btn-primary hidden">Style</button></a>
               </div>  
            </div>
