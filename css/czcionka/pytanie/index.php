...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Edycja tekstu - pytanie</h2>
                <hr>
                <h3> Co odpowiada za wyrównanie tekstu?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">color<br/>
                    <input type="radio" name="question" value="2">font-style<br/>
                  <input type="radio" name="question" value="3">font-size<br/>
                    <input type="radio" name="question" value="4">text-align<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../display/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
