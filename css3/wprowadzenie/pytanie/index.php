...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Wprowadzenie - pytanie</h2>
                <hr>
                <h3> Co umożliwia border-radius?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Pozwala na dodanie gradientu<br/>
                    <input type="radio" name="question" value="2">Pozwala na pogrubienie ramki elementu<br/>
                  <input type="radio" name="question" value="3">Pozwala na zmianę tła strony<br/>
                    <input type="radio" name="question" value="4">Pozwala na zaokrąglanie krawędzi ramki obiektu<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../border-radius/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
            <div class="content_list" id="css3_pytanie_spis_tresci"></div>
        </div>
    </div>
