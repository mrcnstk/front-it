...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Właściwość VISIBILITY - pytanie</h2>
                <hr>
                <h3> Jaką wartość należy wprowadzić, aby ukryć element?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">show<br/>
                    <input type="radio" name="question" value="2">hide<br/>
                  <input type="radio" name="question" value="3">hidden<br/>
                    <input type="radio" name="question" value="4">visible<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../z_index/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
