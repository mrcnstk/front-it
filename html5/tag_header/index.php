    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag HEADER</h2>
                <hr>
                <p>Przed HTML5 sekcję HEADER najczęściej tworzyło się za pomocą DIV'a nadając mu odpowiednie ID. Teraz można po prostu użyć znacznika HEADER:
                </p>  
                <br/>
                <div class="code_box"><br/><p>&lt;header&gt; Tutaj jest nagłówek &lt;/header&gt;<p></div>
                <br/>
                <p>Oczywiście tag ten jest umieszczony w sekcji BODY</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../wprowadzenie/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
