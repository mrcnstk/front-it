    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                ...
                <hr>
                <p> <strong>HTML (HyperText Markup Language)</strong> jest to - mówiąc prosto - język oparty o hiperłącza, który jest zbudowany ze znaczników.
                    Wykorzystuje się go do tworzenia stron internetowych. Cała struktura strony jest opisywana za pomocą wcześniej wspomnianych znaczników, czyli słów kluczowych otoczonych nawiasami ostrymi.
                </p>  
                <br/><p>Poniżej znajduje się przykładowy znacznik HTML:</p>
                <br/>
                <div class="code_box"><br/><p>&lt;p&gt;To jest akapit &lt;/p&gt;<p></div>
                <br/><br/><br/>    
