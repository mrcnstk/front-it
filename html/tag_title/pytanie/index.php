...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag &lt;title&gt; - pytanie</h2>
                <hr>
                <h3>Gdzie powinien znajdować się tak TITLE?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1"> W sekcji HEAD<br/>
                    <input type="radio" name="question" value="2"> W sekcji BODY<br/>
                ...
                <a href="../../tag_p/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
