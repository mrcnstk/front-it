    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Linki - pytanie</h2>
                <hr>
                <h3>Który link jest prawidłowy?</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1">&lt;href="www.google.com"&gt; Jestem linkiem &lt;/a&gt;  <br/>
                    <input type="radio" name="question" value="2"> &lt;a src="www.google.com"&gt; Jestem linkiem &lt;/a&gt; <br/>
                    <input type="radio" name="question" value="3"> &lt;a href="www.google.com"&gt; Jestem linkiem  &lt;/a&gt; <br/>
                    <input type="radio" name="question" value="4"> &lt;href="www.google.com"&gt; Jestem linkiem  &lt;/href&gt; <br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../listy/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
