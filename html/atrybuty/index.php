    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Atrybuty</h2>
                <hr>
                <p>Atrybuty dostarczają nam dodatkowej informacji na temat danego elementu lub tagu, jednocześnie modyfikując go. Większość atrybutów posiada konkretną wartość, która modyfikuje element np. zmienia jego wysokoć, szerokość, wyrównanie do danej krawędzi itp.</p>
                <p>Jest ich cała masa, lecz poniżej zamieścimy kilka z nich w celu zapoznania się:</p>
                <br/>
                ...
                &lt;/head&gt;<br/><br/>
                &lt;body&gt;<br/>
                &lt;p width="100px"&gt; Atrybut ustalający szerokość akapitu &lt;/p&gt; <br/>
                &lt;p height="100px"&gt; Atrybut ustalający wysokość akapitu &lt;/p&gt;<br/>
                &lt;p align="center"&gt; Atrybut, który wyśrodkuje akapit &lt;/p&gt;<br/>
                &lt;/body&gt;<br/>
                &lt;/html&gt;<p></div>
                <br/><br/>
                <p>To tylko kilka przykładów pokazujących, czym jest atrybut. Temat atrybutów jest złożony, lecz na tym etapie najważniejsza jest wiedza, czym jest atrybut, jak go używać i to, że możemy stosować kilka atrybutów jednocześnie.</p>
                <br/>    
