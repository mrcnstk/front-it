...
<body>
    <div id="main">
        ...
        <nav class="nav_bar">
            ...
            <a class="orange" href="index.php">Co dalej?</a>
        </nav>
        <div class="mainbox">
            <div class="course">
                <h2>Co dalej?</h2>
                <hr>
                <p>Jesli udało ci się przejść wszystkie kursy i nadal chcesz się rozwijać, to najlepszym sposobem na naukę będzie stworzenie kilku własnych stron internetowych. Nie muszą one być duże i skomplikowane. Ważne, aby ćwiczyć zdobyte umiejętności i utrwalać wiedzę. W raz z tworzeniem stron przyjdzie czas na bardziej zaawansowane aspekty programowania, o których można znaleźć wiele informacji w internecie.</p>
                <br/><br/>
                <p>Pozostaje mi jedynie podziękować, że skorzystałeś/aś z mojego kursu i życzyć ci powodzenia w rozwijaniu swoich umiejętności!</p>
                <br/><br/>
                <p><i>Marcin Sitko</i></p>
               <br/> 
            </div>
        </div>
    </div>
