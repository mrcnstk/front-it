...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Wypisywanie na ekran</h2>
                <hr>
                <p>Warto zacząć od najprostszych czynności. Spróbujmy wypisać tekst "Hello World!" na ekran za pomocą JavaScript. Posłużymy się tutaj funkcją <b>document.write()</b>, która pozwoli na wypisanie tekstu:</p> 
               <br/>
               <div class="code_box"><br/><p>
                ...
                <br/>
                <p>Powyższa funkcja "wyrzuca" na ekran wprowadzony napis. Jest to tylko mały pokaz możliwości języka JS. W przyszłości poznasz inne metody wyświetlania tekstu.</p>
                <br/><br/><br/>    
