...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Operatory arytmetyczne - pytanie</h2>
                <hr>
                <h3>Jakiego operatora używa się do inkrementacji? </h3>  
                <br/>
                <form>
                ...
                <a href="../../przypisanie/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
