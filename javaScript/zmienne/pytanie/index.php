...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Zmienne - pytanie</h2>
                <hr>
                <h3>Za pomocą jakiego słowa kluczowego deklaruje się zmienną? </h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">nan<br/>
                    <input type="radio" name="question" value="2">var<br/>
                 <input type="radio" name="question" value="3">box<br/>
                   <input type="radio" name="question" value="4">set<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../zmienne_cz2/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
