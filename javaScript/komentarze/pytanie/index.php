    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                ...
                <hr>
                <h3>Komentarze wielolinijkowe zawierają się pomiędzy: </h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">_/ \_<br/>
                    <input type="radio" name="question" value="2">_^ ^_<br/>
                ...
                <a href="../../zmienne/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
