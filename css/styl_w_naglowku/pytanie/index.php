...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Styl w nagłówku - pytanie</h2>
                <hr>
                <h3> Czy style w nagłówku oddziałują na elementy na całej stronie?</h3>  
                <br/>
                <form>
                ...
                <a href="../../styl_zewnetrzny/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
