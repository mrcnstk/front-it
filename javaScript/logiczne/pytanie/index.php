...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Operatory logiczne - pytanie</h2>
                <hr>
                <h3>Czy operator && sprawdza, czy jeden z warunków jest prawdziwy? </h3>  
                <br/>
                <form>
               ...
               <!--  <input type="radio" name="question" value="3">!==<br/>
                ...
                <a href="../../jezeli/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
