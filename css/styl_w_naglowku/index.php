...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Styl w nagłówku</h2>
                <hr>
                <p>Kolejnym sposobem wprowadzania stylów na naszej stronie są "style w nagłówku". Tego rodzaju style zawierają się w sekcji HEAD pomiędzy znacznikami STYLE i zawierają w sobie instrukcje odnośnie tego, na co mają wpływać. Poniższy przykład pokazuje działanie stylów w nagłówku:
        
                </p>  
                <br/>
                <div class="code_box"><br/><p>&#x3C;head&#x3E;<br/>
                    ...<br/>
                    ...<br/>
                    &#x3C;style&#x3E;<br/>
                    h1 { color:red; }<br/>
                ...
                <br/>
                <p>Zaletą takiego stylowania jest fakt, że w naszym przypadku WSZYSTKIE nagłówki H1 na stronie będą w kolorze czerwonym. A co jeśli mamy wiele podstron i chcemy żeby wszystkie nagłówki H1 były czerwone?</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../styl_lokalny/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
