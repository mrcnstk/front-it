    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Selektory CSS</h2>
                <hr>
                <p>Wyrózniamy rózne rodzaje selektorów. Są to elementy na początku definicji stylu, który mówi do czego odnosi się dany styl.<br/>
                Selektorem może być jeden ze znaczników HTML np: <strong> h1, h2, h5</strong> <br/>
                Selektorem może również być klasa. Wystarczy że poprzedzimy nazwę klasy kropką: <strong> .mojaKlasa, .nowaKlasa </strong> <br/>
                Można również zastosować selektor id. Działa podobnie jak selektor klasy, tylko zamiast kropki poprzedzony jest znakiem "#" : <strong> #mójIdentyfikator, #mojaNazwa </strong> <br/>
                <br/>
                Poniżej przykłady deklaracji różnych stylów:
                </p>  
                <br/>
                <div class="code_box"><br/><p>h2 {<br/>
                ...
                <br/>
                <br/>
                <p>Jak widać strony możemy stylować na rózne sposoby. Można dodawać wiele właściwości odnoszących się do jednego selektora. Ważne jest również to, że jedną definicję możemy odnieśc do kilku selektorów wypisując je po przecinku</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../styl_zewnetrzny/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
