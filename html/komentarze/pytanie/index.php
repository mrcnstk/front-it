...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Komentarze - pytanie</h2>
                <hr>
                <h3>Pomiędzy jakimi znakami zawiera się komentarz?</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1">&lt;&excl;&ndash;&ndash; Komentarz? &ndash;&ndash;&gt; <br/>
                    <input type="radio" name="question" value="2">&excl;&lt;&ndash;&ndash; Komentarz &ndash;&ndash;&gt; <br/>
                    <input type="radio" name="question" value="3">&excl;&lt;&ndash; Komentarz! &ndash;&gt; <br/>
                    <input type="radio" name="question" value="4">&lt;&ndash;&ndash; Komentarz? &ndash;&ndash;&gt;<br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../atrybuty/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
            <div class="content_list" id="html_pytanie_spis_tresci"></div>
        </div>
    </div>
