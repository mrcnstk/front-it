...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>ANIMATION - pytanie</h2>
                <hr>
                <h3> Za co odpowiada pierwsza wartość podawana we właściwości ANIMATION?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Jest to nazwa KEYFRAMES<br/>
                    <input type="radio" name="question" value="2">Czas trwania animacji<br/>
                 <input type="radio" name="question" value="3">Opóźnienie animacji<br/>
                   <input type="radio" name="question" value="4">Kierunek animacji<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../koniec/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
