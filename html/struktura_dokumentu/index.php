...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Struktura dokumentu</h2>
                <hr>
                <p> Podstawowym znacznikiem rozpoczynającym tworzenie strony internetowej jest &lt;html&gt;, który oczywiście jest zamykany tagiem &lt;/html&gt;.
                Jest to podstawowy, czysty dokument HTML. Cała zawartość strony powinna znajdować się pomiędzy tymi znacznikami.
                </p>  
                <br/><p>Poniżej znajduje się kod dla utrwalenia informacji:</p>
                <br/>
                <div class="code_box"><br/><p>&lt;html&gt;<br/><br/>&lt;/html&gt;<p></div>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../czym_jest_html/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
