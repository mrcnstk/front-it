    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag ASIDE</h2>
                <hr>
                <p>ASIDE jest kolejnym znacznikiem, który pozwala nam trzymac niezależną treść na stronie, lecz najczęściej jest on umieszczany z boku strony. Poniższy obrazek najlepej zobrazuje nabytą wcześniej wiedzę, a także pokaże, w jaki sposób budować stronę zgodną z HTML5: </p>  
                <br/>
                <span style="margin-left:200px;"><img src="../../images/html5.jpg" alt="html5" style="width:450px; height:300px;"/></span>
                <p style="font-size:8px;"> Źródło: http://codelikethis.com/lessons/www/html5 </p><br/>
                <p>jak pewnie zauważyłeś, w strukturze strony znajduje się także tag SECTION. Jest to nic innego, jak pewnego rodzaju separator danej części kodu, którego możemy przyrównać do sekcji DIV.</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../tag_article/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
