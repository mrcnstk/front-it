    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Linki</h2>
                <hr>
                <p> Link jest jednym z najważniejszych elementów na stronie internetowej. To dzięki niemu możemy przechodzić przez kolejne części kursu, czy szybko wybrać konkretną lekcję ze spisu treści.Linki mogą występować w postaci tekstu, który trzeba kliknąć, lecz mogą również przybierać postać obrazów czy przycisków, które przekierują nas na konkretną stronę.</p>
                <p> Tagiem, który definiuje link jest A - z języka angielskiego "anchor", czyli kotwica. </p>
                <p> Sam tag niestety jest niczym bez atrybutu HREF, który wskazuje konkretną ścieżkę, do której udamy się po kliknięciu w link. Poniżej przykład linku: </p>
                <br/>
                ...
                &lt;/head&gt;<br/><br/>
                &lt;body&gt;<br/>
                &lt;a href="www.google.com"&gt; Jestem linkiem do wyszukiwarki Google! &lt;/a&gt;<br/>
                &lt;/body&gt;<br/>
                &lt;/html&gt;<p></div>
                <br/><br/>
                <p>Jeśli chcielibyśmy, aby np. obraz był linkiem, to zamiast powyższego tekstu możemy umieścić odpowiedni tag IMG.</p>
                <br/>    
                <div class="bottom_buttons">
                <a href="../obrazy/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
