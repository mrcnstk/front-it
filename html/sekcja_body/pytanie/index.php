...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Sekcja &lt;body&gt; - pytanie</h2>
                <hr>
                <h3>Czy w sekcji BODY możemy umieścić linki do stron?</h3>  
                <br/>
                <form>
                ...
                <a href="../../tag_title/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
