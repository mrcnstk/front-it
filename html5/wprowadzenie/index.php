...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>HTML5 - wprowadzenie</h2>
                <hr>
                <p> Jedną z pierwszych linijek, którą wprowadzamy w dokumencie, kiedy piszemy w <strong>HTML5</strong> jest deklaracja DOCTYPE, która wyglada następująco:
                </p>  
                <br/>
                <div class="code_box"><br/><p>&lt;!DOCTYPE HTML&gt;<p></div>
                <br/>
                <p>W sekcji HEAD podajemy także sposób dekodowania znaków:</p>
                <div class="code_box"><br/><p>&lt;meta charset="UTF-8"&gt;<p></div>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../../html/formularze/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
