...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag ARTICLE - pytanie</h2>
                <hr>
                <h3> Do czego stosuje się znacznik ARTICLE?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Do tworzenia artykułów<br/>
                    <input type="radio" name="question" value="2">To tylko kolejny pojemnik na elementy<br/>
                    <input type="radio" name="question" value="3">Nie ma określonego zastosowania<br/>
                    <input type="radio" name="question" value="4">Umieszczamy w nim tylko linki do stron<br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../tag_aside/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
            <div class="content_list" id="html5_pytanie_spis_tresci"></div>
        </div>
    </div>
