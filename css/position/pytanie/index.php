...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Właściwość POSITION - pytanie</h2>
                <hr>
                <h3> Która wartość pozwala na pozycjonowanie wzgledem własnej pozycji?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">static<br/>
                    <input type="radio" name="question" value="2">relative<br/>
                  <input type="radio" name="question" value="3">absolute<br/>
                    <input type="radio" name="question" value="4">fixed<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../visibility/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
