    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Komentarze</h2>
                <hr>
                <p>Jak w każdym języku programowania, tak również i tutaj istnieją komentarze, które pozwolą na łatwiejsze czytanie kodu i zaznaczanie najważniejszych jego elementów.</p> 
               <p> Komentarz jednolinijkowy w języku JavaScript otrzymujemy poprzez dodanie znaków <b>//</b> , a wielolinijkowy zawiera się pomiędzy <b>/*</b> oraz <b>*/</b>. </p>
               <br/>
               <div class="code_box"><br/><p>
                ...
                <a href="../wypisywanie/index.php"><button class="btn-primary">Wstecz</button></a>
