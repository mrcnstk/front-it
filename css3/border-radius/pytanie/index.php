...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>BORDER-RADIUS - pytanie</h2>
                <hr>
                <h3> Czy można ustalić promień zaokrąglenia poszczególnego narożnika?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">TAK<br/>
                    <input type="radio" name="question" value="2">NIE<br/>
                ...
                <a href="../../border-image/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
