...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Struktura dokumentu - pytanie</h2>
                <hr>
                <h3> Pomiędzy jakimi znacznikami zawiera się cała strona internetowa?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">&lt;html&lt; &gt;/html&gt;<br/>
                    <input type="radio" name="question" value="2">&lt;html&gt; &lt;/html&gt;<br/>
                    <input type="radio" name="question" value="3">&lpar;html&rpar; &lpar;/html&rpar;<br/>
                    <input type="radio" name="question" value="4">&lt;html&gt; &lt;\html&gt;<br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../sekcja_head/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>
            </div>
