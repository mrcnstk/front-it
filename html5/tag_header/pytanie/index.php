...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag HEADER - pytanie</h2>
                <hr>
                <h3> Wewnątrz czego umieszczamy tag HEADER?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">HEAD<br/>
                    <input type="radio" name="question" value="2">DIV<br/>
                    <input type="radio" name="question" value="3">BODY<br/>
                    <input type="radio" name="question" value="4">poza HTML<br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../tag_footer/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
