...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag FOOTER - pytanie</h2>
                <hr>
                <h3> Gdzie znajduje się zawartość tagu FOOTER?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Na dole strony<br/>
                    <input type="radio" name="question" value="2">Przy lewej krawędzi strony<br/>
                    <input type="radio" name="question" value="3">Obojętnie<br/>
                    <input type="radio" name="question" value="4">Na górze strony<br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../tag_nav/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
