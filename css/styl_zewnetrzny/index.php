...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Styl zewnętrzny</h2>
                <hr>
                <p>Jeśli przyjdzie nam tworzyć stronę internetową mającą wiele podstron, to z pomocą przyjdą nam style w pliku zewnętrznym. Działa to następująco - tworzymy nowy plik o rozszerzeniu .css i w nim wprowadzamy wszystkie style, natomiast na wszystkich stronach umieszamy link do pliku ze ścieżką do niego:
                </p>  
                <br/>
                <div class="code_box"><br/><p>&#x3C;link rel=&#x22;stylesheet&#x22; href=&#x22;mojPlikStylow.css&#x22;&#x3E;<br/></p>
                </div>
                <br/>
                <p> A wnętrze pliku css wygląda tak: </p>
                <br/>
                ...
                <p>Tutaj główną zaletą jest to, że piszemy style raz i działają one na wielu stronach. Dzisiaj jest to najpopularniejsza metoda stylowania stron.</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../styl_w_naglowku/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
