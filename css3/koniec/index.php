...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Kurs CSS3 - koniec</h2>
                <hr>
                <p>To już koniec wprowadzenia do arkuszy stylów CSS i CSS3. Kurs w przyszłości będzie rozwijany w miarę możliwości. Jeśli zaznajomiłeś się już z tematem tworzenia podstawowych stron HTML i podstawowymi zagadnieniami dotyczącymi arkuszy stylów, to jest to dobry moment, aby poznać język JavaScript, który pozwoli na dodanie ciekawych efektów na twojej stronie.</p>
               <br/>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../animation/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
                <a href="../../javaScript/spis_tresci/index.php"><button class="btn-primary" >JavaScript</button></a>
               </div>  
            </div>
