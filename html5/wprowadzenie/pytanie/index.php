...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Wprowadzenie HTML5 - pytanie</h2>
                <hr>
                <h3> Jakie kodowanie znaków stosuje się w HTML5?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">UTP-3<br/>
                    <input type="radio" name="question" value="2">UTF-8<br/>
                    <input type="radio" name="question" value="3">VPT-5<br/>
                    <input type="radio" name="question" value="4">Kodowanie znaków? Nie ma czegoś takiego!<br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../tag_header/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
