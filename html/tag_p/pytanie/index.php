    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag &lt;p&gt; - pytanie</h2>
                <hr>
                <h3>Wybierz element, który dodaje na stronie akapit z zawartością "Hello World!"</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1">&lt;p&gt; Hey World! &lt;/p&gt;<br/>
                    <input type="radio" name="question" value="2">&lt;p&gt; Hello World! &lt;p/&gt;<br/>
                    <input type="radio" name="question" value="3">&lt;p&gt; Hello World! &lt;/p&gt;<br/>
                    <input type="radio" name="question" value="4">&lt;/p&gt; Hello World! &lt;p&gt;<br/>
                ...
                <a href="../../formatowanie_tekstu/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
