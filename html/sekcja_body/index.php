    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Sekcja &lt;body&gt;</h2>
                <hr>
                <p>Sekcja <strong>BODY</strong> jest drugim głównym elementem składowym pliku html. Zawarte są w niej wszystkie elementy widoczne dla użytkownika strony (czyli przeciwnie do sekcji HEAD).
                Znajdziemy w niej takie elementy jak np. nagłówki, akapity, listy, cytaty, obrazy, linki itd. Jest to jedynie kilka przykładów tego, co można znaleźć w sekcji BODY.
                </p>  
                <br/><p> Aktualnie struktura naszego pliku wygląda następująco:</p>
                <br/>
                ...
                <a href="../sekcja_head/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
