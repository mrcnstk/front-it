...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Instrukcja warunkowa - pytanie</h2>
                <hr>
                <h3>Kiedy wykona się główna część funkcji if </h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">Gdy warunek zostanie spełniony<br/>
                    <input type="radio" name="question" value="2">Gdy warunek nie zostanie spełniony<br/>
               <!--  <input type="radio" name="question" value="3">!==<br/>
                   <input type="radio" name="question" value="4">>=<br/> -->
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../petle/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
