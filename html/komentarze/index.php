    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Komentarze</h2>
                <hr>
                <p>Często zdarza się tak, że kod jest coraz dłuższy i długo szukamy odpowiedniej części kodu. Jak w każdym języku, tak i tutaj przychodzą z pomocą komentarze, czyli tekst pomiędzy odpowiednimi znacznikami, który nie ma wpłymu na działąnie programu. Możemy tutaj opisać funkcję poszczególnego elementu lub zapisać wskazówkę, która w przyszłości może nam pomóc rozszyfrować strukturę danej sekcji.</p>  
                <br/>
                ...
                &lt;/head&gt;<br/><br/>
                &lt;body&gt;<br/>
                &lt;&excl;&ndash;&ndash; Pomiędzy tymi znakami znajduje się komentarz &ndash;&ndash;&gt;<br/>
                &lt;/body&gt;<br/>
                &lt;/html&gt;<p></div>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../naglowki/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
