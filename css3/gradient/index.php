...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>LINEAR-GRADIENT i RADIAL-GRADIENT</h2>
                <hr>
                <p>Powyższe dwie nazwy nie są samymi w sobie własnościami. Bardziej pełnią rolę funkcji pobierających kolory, z których tworzony jest gradient. Gradient sam w sobie daje efekt płynnego przejścia kolorów. Przykładowe użycie LINEAR-GRADIENT:</p> 
               <br/>
              <div class="code_box"><br/><p>
                p {<br/>
                border:2px solid green;<br/>
                background-image: linear-gradient(down, red, yellow);<br/>
                }<br/>
                </p></div><br/>
               <p> wartość <b> down</b> mówi, że zmiana koloru następuje od góry do dołu. Dopuszczalne są również wartości: up, left, right</p><br/>
               <p>Kolejną opcją tworzenia gradientu jest użycie RADIAL-GRADIENT, który działa bardzo podobnie do wcześniejszego gradientu liniowego, z tym że jest tworzony ze środka obiektu:</p> <br/>
               <div class="code_box"><br/><p>
                p {<br/>
                border:2px solid green;<br/>
                background-image: radial-gradient(circle, red, yellow);<br/>
                }<br/>
                </p></div><br/>
                <p>Wartość <b> circle</b> mówi, że gradient będzie rozchodził się kołowo. Możemy również podać wartość <b>elipse</b>, która jest domyslna i daje efekt eliptycznego rozchodzenia się kolorów.</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../box_shadow/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
