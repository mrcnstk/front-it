    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag &lt;title&gt;</h2>
                <hr>
                <p>Tag <strong>TITLE</strong> służy do nadania nazwy stronie. Nazwa ta będzie widoczna w karcie danej strony - jest to jeden z podstawowych elementów, który umieszczony jest w sekcji HEAD.
                </p>  
                <br/><p> Prawidłowa implementacja tagu TITLE:</p>
                <br/>
                ...
                <a href="../sekcja_body/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
