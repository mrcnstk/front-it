...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Właściwość DISPLAY - pytanie</h2>
                <hr>
                <h3> Która wartość rozciąga obiekt na całą możliwą szerokość?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">block<br/>
                    <input type="radio" name="question" value="2">none<br/>
                  <input type="radio" name="question" value="3">inline-block<br/>
                    <input type="radio" name="question" value="4">inline<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../position/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
