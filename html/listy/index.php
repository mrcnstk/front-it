    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Listy</h2>
                <hr>
                <p> Wyróżniamy dwa podstawowe rodzaje list - numerowana i nienumerowana. Najpierw zaczniemy od listy numerowanej. Rozpoczyna się ona tagiem OL, a każdy jej element zawiera się w tagach LI. Przykład:</p>
                <br/>
                <ol style="font-family: 'Montserrat', sans-serif;margin-left:150px;">
                <li>Jestem</li>
                <li>Listą</li>
                <li>Numerowaną</li>
                </ol>
                <br/>
                <p>Natomiast kod wygląda następująco:</p> 
                <div class="code_box"><br/><p>&lt;html&gt;<br/>
                &lt;head&gt;<br/>
                &lt;title&gt; Lista numerowana &lt;/title&gt;<br/>
                &lt;/head&gt;<br/><br/>
                &lt;body&gt;<br/>
                &lt;ol&gt; <br/>
                &lt;li&gt; Jestem &lt;/li&gt;<br/>
                ...
                &lt;/html&gt;<p></div>
                <br/><br/>
                <p>Podobnie ma się sprawa z listą nienumerowaną. Różnica jest tylko taka, że zawiera się ona pomiędzy tagami UL:</p>
                <br/>
                <ul style="font-family: 'Montserrat', sans-serif;margin-left:150px;">
                <li>Jestem</li>
                <li>Listą</li>
                <li>Nienumerowaną</li>
                </ul>
                <br/>  
                <p> Kod listy nienumerowanej:</p>  
                <div class="code_box"><br/><p>&lt;html&gt;<br/>
                &lt;head&gt;<br/>
                ...
                &lt;li&gt; Jestem &lt;/li&gt;<br/>
                &lt;li&gt; Listą &lt;/li&gt;<br/>
                &lt;li&gt; Nienumerowaną &lt;/li&gt;<br/>
                &lt;/ul&gt;<br/>
                &lt;/body&gt;<br/>
                &lt;/html&gt;<p></div>
                <br/><br/>
                <div class="bottom_buttons">
                <a href="../linki/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
