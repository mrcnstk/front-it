...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Operatory porównania - pytanie</h2>
                <hr>
                <h3>Który operator sprawdza, czy zmienne są równe i tego samego typu? </h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">===<br/>
                    <input type="radio" name="question" value="2">==<br/>
                ...
                <a href="../../logiczne/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
