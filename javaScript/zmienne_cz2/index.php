...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Zmienne - część 2</h2>
                <hr>
                <p>Poniżej przedstawimy kilka rodzajów zmiennych, które są dostępne w JavaScript:</p> 
                
               <br/>
               <p> Typ rzeczywisty (float): <b> var cena=4.50;</b>  - jest to rodzaj zmiennych zawierający liczby rzeczywiste</p> <br/>
               <br/>
               <p> Ciąg znaków (string): <b> var imie='Mariusz';</b>  - zmienna tego typu zawiera ciągi znaków</p> <br/>
               <br/>
               <p> Typ logiczny (boolean): <b> var czyJestWeekend=true;</b>  - jest to logiczny rodzaj zmiennej, która przyjmuje wartość <b>true</b> lub <b>false</b></p> <br/>
               <br/>
               <div class="code_box"><br/><p>
                ...
                &lt;script&gt;<br/>
                var Imie = 'Mariusz';<br/>
                var cenaButow = 39.99;<br/>
                var numerButa = 44; //zmienna przechowująca cyfry<br/>
                &lt;/script&gt;<br/>
                &lt;/body&gt;<br/>
                </p></div>
                <br/>
                ...
                <a href="../zmienne/index.php"><button class="btn-primary">Wstecz</button></a>
