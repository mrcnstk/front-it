    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag FOOTER</h2>
                <hr>
                <p>Jest to - podobnie jak sekcja HEADER - zastępca DIV'a. Jego przeznaczenie to zawartość strony znajdująca się na dole, czyli tak zwana "stopka"
                </p>  
                <br/>
                <div class="code_box"><br/><p>&lt;footer&gt; Kontakt: frontit@edu.com &lt;/footer&gt;<p></div>
                <br/>
                <p>Ten tag również znajduje się w sekcji BODY</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../tag_header/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
