    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Listy - pytanie</h2>
                <hr>
                <h3>Czy lista numerowana może się znaleźć wewnątrz listy nienumerowanej?</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1"> Tak  <br/>
                    <input type="radio" name="question" value="2"> Nie <br/>
                    <input type="radio" name="question" value="3"> Nie zawsze <br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../tabele/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
