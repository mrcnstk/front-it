...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>BORDER-IMAGE - pytanie</h2>
                <hr>
                <h3> Jak podajemy źródło obrazu?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">url(obraz.png)<br/>
                    <input type="radio" name="question" value="2">href="obraz.png"<br/>
                 <input type="radio" name="question" value="3">href(obraz.png)<br/>
                   <input type="radio" name="question" value="4">url="obraz.png"<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../box-shadow/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
