...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Sekcja &lt;head&gt; - pytanie</h2>
                <hr>
                <h3> Czy elementy umieszczone w sekcji HEAD są widoczne dla odwiedzających stronę internetową?</h3>  
                <br/>
                <form>
                ...
                <a href="../../sekcja_body/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
