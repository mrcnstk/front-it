...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Zmienne cz. 2 - pytanie</h2>
                <hr>
                <h3>Jak nazywa się typ zmiennych, przechowujących wartości true albo false? </h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">boolean<br/>
                    <input type="radio" name="question" value="2">var<br/>
                 <input type="radio" name="question" value="3">string<br/>
                   <input type="radio" name="question" value="4">float<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../operatory/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
