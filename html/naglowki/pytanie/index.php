...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Nagłówki - pytanie</h2>
                <hr>
                <h3>Który nagłówek ma największe znaczenie dla wyszukiwarki?</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1">&lt;h2&gt; <br/>
                    <input type="radio" name="question" value="2">&lt;h6&gt; <br/>
                    <input type="radio" name="question" value="3">&lt;h1&gt; <br/>
                    <input type="radio" name="question" value="4">&lt;h4&gt;<br/>
                </form>
                <br/><br/><br/>    
