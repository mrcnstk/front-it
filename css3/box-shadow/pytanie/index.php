...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>BOX-SHADOW - pytanie</h2>
                <hr>
                <h3> Za co jest odpowiedzialny drugi parametr BOX-SHADOW?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">poziomy offset<br/>
                    <input type="radio" name="question" value="2">pionowy offset<br/>
                 <input type="radio" name="question" value="3">kolor<br/>
                   <input type="radio" name="question" value="4">podkreślenie<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../gradient/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
