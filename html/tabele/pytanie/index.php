...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tabele - pytanie</h2>
                <hr>
                <h3>Jaki tag jest odpowiedzialny za tworzenie nowego wiersza?</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1">row<br/>
                    <input type="radio" name="question" value="2"> td <br/>
                    <input type="radio" name="question" value="3"> tr <br/>
                    <input type="radio" name="question" value="4"> th <br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../formularze/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
