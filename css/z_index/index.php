...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Właściwość Z-INDEX</h2>
                <hr>
                <p>Często zdarza się, że kilka elementów nachodzi na siebie. Z pomocą przychodzi właściwość Z-INDEX, która decyduje o tym, który element będzie "z przodu", a który "z tyłu".
                Element, któremu nadaliśmy wyższą wartość Z-INDEX będzie z przodu, a ten, który ma mniejszą wartośc będzie za nim: </p> 
               <br/>
               <p> z-index: <b>5</b>&nbsp;&nbsp;&nbsp; <i>Element przyjmuje wyższą wartość, czyli jest z przodu</i><br/></p>
               <p> z-index: <b>3</b>&nbsp;&nbsp;&nbsp; <i>Element przyjmuje niższą wartość, czyli jest ukryty za elementem o indeksie 5</i><br/></p>
              <!-- <div class="code_box"><br/><p>
                </p></div> -->
                
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../visibility/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
