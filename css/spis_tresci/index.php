...
<body>
    <div id="main">
        ...
        <nav class="nav_bar">
            ...
            <a class="blue" href="index.php">CSS</a>
        ...
        <div class="mainbox">
            <div class="course">
                ...
                <ul>
                    <li><a href="../styl_lokalny/index.php">Styl lokalny</a></li>
                    <li class="hidden"><a href="../styl_w_naglowku/index.php">Styl w nagłówku</a></li>
                    <li class="hidden"><a href="../styl_zewnetrzny/index.php">Styl zewnętrzny</a></li>
                    <li class="hidden"><a href="../selektory/index.php">Selektory</a></li>
                    <li class="hidden"><a href="../komentarze/index.php">Komentarze</a></li>
                    <li class="hidden"><a href="../czcionka/index.php">Edycja tekstu</a></li>
                    <li class="hidden"><a href="../display/index.php">Własność DISPLAY</a></li>
                    <li class="hidden"><a href="../position/index.php">Własność POSITION</a></li>
                    <li class="hidden"><a href="../visibility/index.php">Właściwość VISIBILITY</a></li>
                    <li class="hidden"><a href="../z_index/index.php">Z-INDEX</a></li>
                </ul>           
            </div>
