...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Formatowanie tekstu - pytanie</h2>
                <hr>
                <h3>Który znacznik odpowiada za pogrubienie tekstu?</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1">&lt;i&gt; <br/>
                    <input type="radio" name="question" value="2">&lt;b&gt; <br/>
                    <input type="radio" name="question" value="3">&lt;del&gt; <br/>
                    <input type="radio" name="question" value="4">&lt;u&gt;<br/>
                ...
                <a href="../../naglowki/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
