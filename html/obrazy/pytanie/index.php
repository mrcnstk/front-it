...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Obrazy - pytanie</h2>
                <hr>
                <h3>Który atrybut tagu IMG odpowiada za wyświetlenie alternatywnego tekstu w przypadku nieprawidłowego wczytania się obrazu?</h3>  
                <br/>
                <form>
                <input type="radio" name="question" value="1"> src <br/>
                    <input type="radio" name="question" value="2"> width <br/>
                    <input type="radio" name="question" value="3"> alt <br/>
                    <input type="radio" name="question" value="4"> align <br/>
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../linki/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
