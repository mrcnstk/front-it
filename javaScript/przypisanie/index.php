    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                ...
                <hr>
                <p>Operatory przypisania służą do przypisywania wartości do zmiennych. Poniższa tabela pokazuje na przykładach, jak działają takie operatory (tabela dla <b> x=10 oraz y=5</b>):</p> 
               <br/>
               <img src="../../images/przypisanie.png" alt="Operatory przypisania" style="margin-left:100px;"/>
               <br/>
               <p style="font-size:10px;">Źródło: https://kursjs.pl/kurs/super-podstawy/operatory.php</p>
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../operatory/index.php"><button class="btn-primary">Wstecz</button></a>
