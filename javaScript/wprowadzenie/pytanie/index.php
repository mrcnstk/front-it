...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>JavaScript wprowadzenie - pytanie</h2>
                <hr>
                <h3> Gdzie trzeba umieścić skrypt, aby wykonał się po załadowaniu zawartości strony?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">na początku tagu BODY<br/>
                    <input type="radio" name="question" value="2">przed zamykającym tagiem BODY<br/>
                 <input type="radio" name="question" value="3">w sekcji HEAD<br/>
                   <input type="radio" name="question" value="4">przed zamykającym tagiem HTML<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../wypisywanie/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
            <div class="content_list" id="js_pytanie_spis_tresci"></div>
        </div>
    </div>
