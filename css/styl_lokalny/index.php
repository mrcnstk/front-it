    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Styl lokalny</h2>
                <hr>
                <p>Początek przygody z CSS warto rozpocząć od wprowadzenia pojęcia "stylu lokalnego" (ang. inline CSS). Dzięki takiemu stylowaniu konkretnie zadane zmiany będą działać jedynie na elemencie do którego jest "podpięty" styl. Poniższy przykład najlepiej wyjaśni działanie tego typu stylów:
                </p>  
                <br/>
                <div class="code_box"><br/><p>
                &lt;p style="color:red;"&gt;<br/>&lt;article&gt;<br/>
                &lt;p&gt;To jest jakiś artykuł &lt;/p&gt;<br/>
                &lt;/article&gt;<br/>
                </p></div>
                <br/>
                <p>Jak można zauważyć, w otwierającym tagu P znajduje się atrybut STYLE, który w cudzysłowie przechowuje informację, o zmianie koloru na czerwony. Zmiana zadziała na zawartość znajdującą się pomiędzy znacznikami ARTICLE.</p>
                <br/><br/><br/>    
