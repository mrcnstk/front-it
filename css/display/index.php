...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Właściwość DISPLAY</h2>
                <hr>
                <p>Poniżej wymienione wartości parametru DISPLAY, które pozwolą zmieniać sposób wyświetlania konkretnych elementów:</p> 
                <p><br/>
                <b>block</b> - element zajmuje całą możliwą szerokość, lecz tylko potrzebną wysokość
                <br/>
                <b>inline</b> - element zajmuje tylko potrzebną wysokość i szerokość
                <br/>
                <b>none</b> - element zostaje ukryty i nie zajmuje żadnego miejsca
                </p><br/>
                
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../czcionka/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
