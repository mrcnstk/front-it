    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>Tag &lt;p&gt;</h2>
                <hr>
                <p>Tag <strong>p</strong> służy do stworzenia akapitu. Akapity następujące po sobie są rozdzielane linijką przerwy. Przyjęte jest, że większość tekstu umieszczonego na stronie zawiera się pomiędzy tagami P. Jako, że tekst jest elementem, który chcemy widzieć na stronie, umieszczamy go wraz z zawartością w sekcji BODY.
                </p>  
                <br/><p> Przykładowy kod:</p>
                <br/>
                ...
                <a href="../tag_title/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
