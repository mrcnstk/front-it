    ...
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>BORDER-IMAGE</h2>
                <hr>
                <p>Własność BORDER-IMAGE pozwala na ustawienie obrazu jako ramki dla danego elementu. Przyjmuje parametry: źródło obrazu, cięcie obrazu i rodzaj wyświetlania</p> 
               <br/>
              <div class="code_box"><br/><p>
                p {<br/>
                border:2px solid green;<br/>
                border-image: url(ścieżkaDoObrazu.png) 30 round;<br/>
                }<br/>
                </p></div>
               
                <br/><br/><br/>    
                <div class="bottom_buttons">
                <a href="../border_radius/pytanie/index.php"><button class="btn-primary">Wstecz</button></a>
