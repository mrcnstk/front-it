...
<body>
    <div id="main">
        ...
        <div class="mainbox">
            <div class="course">
                <h2>LINEAR-GRADIENT i RADIAL-GRADIENT - pytanie</h2>
                <hr>
                <h3> Jaki jest domyślny sposób przejścia kolorów w funkcji RADIAL-GRADIENT?</h3>  
                <br/>
                <form>
                    <input type="radio" name="question" value="1">down<br/>
                    <input type="radio" name="question" value="2">circle<br/>
                 <input type="radio" name="question" value="3">elipse<br/>
                   <input type="radio" name="question" value="4">square<br/> 
                </form>
                <br/><br/><br/>    
                ...
                <a href="../../animation/index.php"><button name="go" class="btn-primary hidden">Dalej</button></a>
               </div>  
            </div>
